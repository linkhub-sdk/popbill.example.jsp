...
*
* - JSP SDK 연동환경 설정방법 안내 : https://developers.popbill.com/guide/cashbill/java/getting-started/tutorial?fwn=jsp
* - 업데이트 일자 : 2023-02-14
...
<jsp:setProperty name="cashbillService" property="test" value="false"/>
