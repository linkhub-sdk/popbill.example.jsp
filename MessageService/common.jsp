...
<jsp:setProperty name="messageService" property="secretKey" value="kcZrgaTm8V8i3MisdunwWOHDTCjMq/+o/dyENejL+mo="/>

<%-- API요청 환경설정을 위한 설정값 true(테스트용), false(상업용) 상업용으로 전환 시 false로 처리 --%>
