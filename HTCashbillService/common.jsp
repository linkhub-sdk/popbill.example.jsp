...
*
* - JSP SDK 연동환경 설정방법 안내 : https://docs.popbill.com/htcashbill/tutorial/jsp
* - 업데이트 일자 : 2020-08-07
...
<jsp:useBean id="htCashbillService" scope="application" class="com.popbill.api.hometax.HTCashbillServiceImp"/>
...
<%-- UseLocalTimeYN : 로컬서버 타임 사용여부 true-사용(기본값-권장), false-미사용 --%>
